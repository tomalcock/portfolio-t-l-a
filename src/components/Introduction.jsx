...
function Introduction() {
  return (
    <div className='flex justify-center flex-col items-center mb-36'>
      ...
      <h2 className='mt-5 text-center text-white font-medium text-[13px] tracking-widest'>Hi! My name is</h2>
      ...
      <a className='button mt-6' href={tomCv}>Download my CV</a>
    </div>
  )
}
